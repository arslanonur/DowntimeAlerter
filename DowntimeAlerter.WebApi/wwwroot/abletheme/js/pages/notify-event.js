...
$(function() {
    ...
    // Solid default
    $("#pnotify-solid-default").on("click",
        function() {
            new PNotify.alert({
                title: "default notice",
                text: "Check me out! I'm a notice.",
    ...
    // Solid inverse
    $("#pnotify-solid-inverse").on("click",
        function() {
            new PNotify.alert({
                title: "Info notice",
                text: "Check me out! I'm a notice.",
    ...
    // Danger
    $("#pnotify-desktop-notice").on("click",
        function() {
            PNotify.notice({
    ...
    $("#pnotify-rich").on("click",
        function() {
            PNotify.notice({
                ...
                titleTrusted: true,
                text: '<span style="color: blue;">Look at my beautiful <strong>strong</' +
