...
$(document).ready(function() {
    ...
    $("button#clear-all-tasks").on("click",
        function() {
            $("#task-list li").remove();
    ...
    $(".icofont icofont-ui-delete").on("click",
        function() {
    ...
    $("#add-btn").on("click",
        function() {
            ...
            if (task == "") {
                ...
                var add_todo = $('<div class="to-do-list mb-3" id="' +
                    i +
                    '"><div class="d-inline-block"><label class="check-task custom-control custom-checkbox d-flex justify-content-center"><input type="checkbox" class="custom-control-input" onclick="check_task(' +
                    i +
                    ')" id="checkbox' +
                    i +
                    '"><span class="custom-control-label" for="checkbox' +
                    i +
                    '">' +
                    task +
...
$(".to-do-label input[type=checkbox]").on("click",
    function() {
        if ($(this).prop("checked"))
            $(this).parent().addClass("done-task");
        else
