...
$(document).ready(function() {
    ...
    // close card
    $(".card-option .close-card").on("click",
        function() {
            var $this = $(this);
    ...
    // reload card
    $(".card-option .reload-card").on("click",
        function() {
            var $this = $(this);
    ...
    $(".card-option .minimize-card").on("click",
        function() {
            var $this = $(this);
    ...
    // full card
    $(".card-option .full-card").on("click",
        function() {
            var $this = $(this);
            var port = $($this.parents(".card"));
...
function menuhrres() {
    ...
    if (vw < 992) {
        setTimeout(function() {
                $(".sidenav-horizontal-wrapper").addClass("sidenav-horizontal-wrapper-dis")
    ...
    var PcodedMenu = {
        ...
        HandleSubMenuTrigger: function() {
            ...
            if ($(".pcoded-navbar").hasClass("theme-horizontal") == true ||
                ...
                if ((newSize >= 992 && $("body").hasClass("layout-6") ||
                    ...
                    if ($("body").hasClass("layout-6") || $("body").hasClass("layout-7")) {
                        ...
                        if (!$(".pcoded-navbar").hasClass("theme-horizontal-dis")) {
                                    ...
                                    if (str === 0) {
                                        if ($(this).hasClass("pcoded-trigger")) {
                                            ...
                                            $(".pcoded-submenu > li > .pcoded-submenu > li.pcoded-trigger")
                                                .children(".pcoded-submenu").slideUp();
                                            $(this).closest(".pcoded-inner-navbar").find("li.pcoded-trigger")
                                        ...
                                        if ($(this).hasClass("pcoded-trigger")) {
                                            ...
                                            $(".pcoded-submenu > li > .pcoded-submenu > li.pcoded-trigger")
                                                .children(".pcoded-submenu").slideUp();
                                            $(this).closest(".pcoded-submenu").find("li.pcoded-trigger")
                                                .removeClass("pcoded-trigger");
                                            $(this).addClass("pcoded-trigger");
                                            $(this).children(".pcoded-submenu").slideDown();
                                        }
                            ...
                            $(".pcoded-inner-navbar .pcoded-submenu > li > .pcoded-submenu > li").on("click",
                                function(e) {
                                    e.stopPropagation();
                                    var str = $(this).closest(".pcoded-submenu").length;
                                    if (str === 0) {
                                        if ($(this).hasClass("pcoded-trigger")) {
                                            ...
                                            $(".pcoded-hasmenu li.pcoded-trigger").children(".pcoded-submenu")
                                                .slideUp();
                                            $(this).closest(".pcoded-inner-navbar").find("li.pcoded-trigger")
                                                .removeClass("pcoded-trigger");
                                            $(this).addClass("pcoded-trigger");
        ...
        HandleMenuTrigger: function() {
            ...
            if (newSize >= 992) {
                if ($(".pcoded-navbar").hasClass("theme-horizontal") == true) {
                    if ((newSize >= 768 && $("body").hasClass("layout-6") ||
    ...
    if (!$("body").hasClass("layout-14")) {
        if (this.href == pageUrl && $(this).attr("href") != "") {
            ...
            if (!$(".pcoded-navbar").hasClass("theme-horizontal")) {
                ...
                $(this).parent("li").parent().parent(".pcoded-hasmenu").parent().parent(".pcoded-hasmenu")
...
// more-details end
$("body").append(
    '<div class="fixed-button active"><a href="https://1.envato.market/qG0m5" target="_blank" class="btn btn-md btn-primary"><i class="fa fa-shopping-cart" aria-hidden="true"></i> Upgrade To Pro</a> </div>');
