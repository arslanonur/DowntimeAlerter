...
(function(root, factory) {
    ...
    function init($, undefined) {
        ...
        exports.dialog = function(options) {
            ...
            if (options.size) {
                ...
                if (options.fullBootstrapVersion.substring(0, 3) < "3.1") {
                    console.warn('"size" requires Bootstrap 3.1.0 or higher. You appear to be using ' +
            ...
            if (options.scrollable) {
                ...
                if (options.fullBootstrapVersion.substring(0, 3) < "4.3") {
                    console.warn('Using "scrollable" requires Bootstrap 4.3.0 or higher. You appear to be using ' +
                        options.fullBootstrapVersion +
                        ". Please upgrade to use this option.");
                }
            }
            ...
            if (options.centerVertical) {
                ...
                if (options.fullBootstrapVersion < "4.0.0") {
                    console.warn('"centerVertical" requires Bootstrap 4.0.0-beta.3 or higher. You appear to be using ' +
                        options.fullBootstrapVersion +
                        ". Please upgrade to use this option.");
                }
            }
        ...
        exports.prompt = function() {
            ...
            promptDialog.on("shown.bs.modal",
                function() {
